...
$sql = "SELECT * FROM bar_rating WHERE bar_rating_id=$bar_rating_id";

$row = $pdo->query($sql)->fetch();
if (empty($row)) {
    header('Location: bar_rating_list.php');
    exit; # 結束 php 程式 
}
?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="sendForm(event)">
                        <div class="mb-3">
                            <label class="form-label">bar_rating_id</label>
                            <input type="text" class="form-control" disabled value="<?= $row['bar_rating_id'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <input type="hidden" name="bar_rating_id" value="<?= $row['bar_rating_id'] ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="bar_rating_star" class="form-label">bar_rating_star</label>
                            <input type="text" class="form-control" id="bar_rating_star" name="bar_rating_star"
                                value="<?= $row['bar_rating_star'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <!-- <input type="hidden" name="bar_rating_star" value="<?= $row['bar_rating_star'] ?>"> -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="./bar_rating_list.php">Return</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    let initialValues = {
    bar_rating_id: document.form1.bar_rating_id.value,
    bar_id: document.form1.bar_id.value,
    user_id: document.form1.user_id.value,
    bar_rating_star: document.form1.bar_rating_star.value
    };
    const sendForm = e => {
    ...
    // 檢查是否有更改
        let isChanged = initialValues.bar_rating_id !== document.form1.bar_rating_id.value ||
                initialValues.bar_id !== document.form1.bar_id.value ||
                initialValues.user_id !== document.form1.user_id.value ||
                initialValues.bar_rating_star !== document.form1.bar_rating_star.value;
