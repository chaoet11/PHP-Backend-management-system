...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="row align-items-center">
            ...
            <!-- add button start -->
            <div class="col-auto">
                <a href="bar_time_slots_add.php" class="btn btn-primary mb-3"><i class="fa-solid fa-plus"></i></a>
            </div>
            <!-- add end start -->
        </div>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="javascript: delete_one(<?= $row['bar_time_slot_id'] ?>)">
                    ...
                    <!-- 避免 XSS 攻擊問題 -->
                    <td>
                        <a href="bar_time_slots_edit.php?bar_time_slot_id=<?= $row['bar_time_slot_id'] ?>">
