                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation"novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="bar_rating_id" class="form-label">bar_rating_id</label>
                                <input type="text" class="form-control" id="bar_rating_id" name="bar_rating_id">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bar_rating_star" name="bar_rating_star" required>
                                <div class="invalid-feedback">Please provide a valid bar_rating_star.</div>
                            </div>
