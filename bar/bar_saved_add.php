                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="bar_saved_id" class="form-label">bar_saved_id</label>
                                <input type="text" class="form-control" id="bar_saved_id" name="bar_saved_id">
...
<script>
    ...
    function submitCsv() {
        ...
        fetch('bar_saved_add-csv-api.php', {
            method: 'POST',
            body: formData,
        })
        .then(response => {
