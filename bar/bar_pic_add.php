                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="bar_pic_id" class="form-label">bar_pic_id</label>
                                <input type="text" class="form-control" id="bar_pic_id" name="bar_pic_id">
                                <div class="form-text"></div>
                            </div> -->
                            <div class="mb-3">
                                <label for="bar_pic_name" class="form-label">bar_pic_name</label>
                                <input type="text" class="form-control" id="bar_pic_name" name="bar_pic_name" required>
                                <div class="invalid-feedback">Please provide a valid bar_pic_name.</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="bar_img" class="form-label">Image</label>
                                <input type="file" class="form-control" id="bar_img" name="bar_img">
