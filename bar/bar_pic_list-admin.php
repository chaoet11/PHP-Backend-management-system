...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="row align-items-center">
            ...
            <!-- add button start -->
            <div class="col-auto">
                <a href="bar_pic_add.php" class="btn btn-primary mb-3"><i class="fa-solid fa-plus"></i></a>
            </div>
            <!-- add end start -->
        </div>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                <td>
                        <a href="javascript: delete_one(<?= $row['bar_pic_id'] ?>)">
                    ...
                    <td>
                        <img src="<?= $row['bar_img'] ?>" alt="Photo" style="width: 160px; height: 100px; cursor: pointer;" onclick="showImageModal(this.src)">
                    </td>
                    <!-- strip_tags -->
                    <!-- 避免 XSS 攻擊問題 -->
                    <td>
                        <a href="bar_pic_edit.php?bar_pic_id=<?= $row['bar_pic_id'] ?>">
