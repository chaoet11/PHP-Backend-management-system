                    ...
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bar_time_slot_id" name="bar_time_slot_id" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="bar_start_time" name="bar_start_time" required>
                                <div class="invalid-feedback">Please provide a valid bar_start_time.</div>
                            </div>
                            <div class="mb-3">
                                <label for="bar_end_time" class="form-label">bar_end_time</label>
                                <input type="text" class="form-control" id="bar_end_time" name="bar_end_time" required>
                                <div class="invalid-feedback">Please provide a valid bar_end_time.</div>

                            </div>
                            <div class="mb-3">
                                <label for="bar_max_capacity" class="form-label">bar_max_capacity</label>
                                <input type="text" class="form-control" id="bar_max_capacity" name="bar_max_capacity" required>
                                <div class="invalid-feedback">Please provide a valid bar_max_capacity.</div>
...
<script>
    const sendForm = e => {
        ...
        if (isPassed) {
            ...
            fetch('bar_time_slots_add-api.php', {
                method: 'POST',
