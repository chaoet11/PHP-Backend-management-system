...
$sql = "SELECT * FROM booking_seat_system WHERE seat_id=$seat_id";
...
<div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" onsubmit="sendForm(event)">
                            <div class="mb-3">
                                <label class="form-label">seat_id</label>
                                <input type="text" class="form-control" disabled value="<?= $row['seat_id'] ?>">
                                <div class="form-text"></div>
                            </div>
                            <input type="hidden" name="seat_id" value="<?= $row['seat_id'] ?>">
                            <div class="mb-3">
                                <label for="seat_uuid" class="form-label">seat_uuid</label>
                                <input type="text" class="form-control" id="user_id" name="seat_uuid" value="<?= $row['seat_uuid'] ?>">
                                <div class="form-text"></div>
                            </div>
                            <div class="mb-3">
    ...
    <script>
        let initialValues = {
            seat_id: document.form1.seat_id.value,
            seat_uuid: document.form1.seat_uuid.value,
            seat_status: document.form1.seat_status.value,
        ...
        const sendForm = e => {
            ...
            // 檢查是否有更改
            let isChanged = initialValues.seat_id !== document.form1.seat_id.value ||
                initialValues.seat_uuid !== document.form1.seat_uuid.value ||
                initialValues.seat_status !== document.form1.seat_status.value ||
            ...
            if (isPassed) {
                ...
                fetch('booking_seat_system_edit-api.php', {
                        method: 'POST',
