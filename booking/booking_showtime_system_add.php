                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" onsubmit="sendForm(event)">
                            <div class="mb-3">
                                <label for="show_time_id" class="form-label">show_time_id</label>
                                <input type="text" class="form-control" id="show_time_id" name="show_time_id">
...
<script>
    const sendForm = e => {
        ...
        if (isPassed) {
            ...
            fetch('booking_showtime_system_add-api.php', {
                method: 'POST',
