                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" onsubmit="sendForm(event)">
                            <div class="mb-3">
                                <label for="points_decrease_id" class="form-label">points_decrease_id</label>
                                <input type="text" class="form-control" id="points_decrease_id" name="points_decrease_id">
...
<script>
    const sendForm = e => {
        ...
        if (isPassed) {
            ...
            fetch('booking_points_dec_add-api.php', {
                method: 'POST',
