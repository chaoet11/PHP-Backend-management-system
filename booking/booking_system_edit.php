...
$sql = "SELECT * FROM booking_system WHERE booking_id=$booking_id";

$row = $pdo->query($sql)->fetch();
if (empty($row)) {
    header('Location: booking_system_list.php');
    exit; # 結束 php 程式 
}
?>
                ...
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="sendForm(event)">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- <input type="text" class="form-control" id="points_change" name="order_status" -->
...
<script>
    const sendForm = e => {
        ...
        if (isPassed) {
            ...
            fetch('booking_system_edit-api.php', {
                method: 'POST',
