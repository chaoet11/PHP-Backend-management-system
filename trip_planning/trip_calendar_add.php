                    ...
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="trip_plan_id" name="trip_plan_id" required>
                                <div class="invalid-feedback">Please provide a valid trip_plan_id。</div>
                            </div>
                            <div class="mb-3">
                                <label for="primary_trip_detail_id" class="form-label">primary_trip_detail_id</label>
                                <input type="text" class="form-control" id="primary_trip_detail_id" name="primary_trip_detail_id" required>
                                <div class="invalid-feedback">Please provide a valid primary_trip_detail_id。</div>
                            </div>
                            <div class="mb-3">
                                <label for="secondary_trip_detail_id" class="form-label">secondary_trip_detail_id</label>
                                <input type="text" class="form-control" id="secondary_trip_detail_id" name="secondary_trip_detail_id">
                                <div class="invalid-feedback">Please provide a valid secondary_trip_detail_id。</div>
                            </div>
                            <div class="mb-3">
                                <label for="tertiary_trip_detail_id" class="form-label">tertiary_trip_detail_id</label>
                                <input type="text" class="form-control" id="tertiary_trip_detail_id" name="tertiary_trip_detail_id">
                                <div class="invalid-feedback">Please provide a valid tertiary_trip_detail_id。</div>
                            </div>
...
<script>
    const sendForm = e => {
        ...
        fetch('trip_calendar_add-api.php', {
                method: 'POST',
