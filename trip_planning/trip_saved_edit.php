...
$sql = "SELECT * FROM trip_saved WHERE trip_saved_id=$trip_saved_id";

$row = $pdo->query($sql)->fetch();
if (empty($row)) {
    header('Location: trip_saved_list.php');
    exit; # 結束 php 程式 
}
?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" onsubmit="sendForm(event)">
                            <div class="mb-3">
                                <label class="form-label">trip_saved_id</label>
                                <input type="text" class="form-control" disabled value="<?= $row['trip_saved_id'] ?>">
                                <div class="form-text"></div>
                            </div>
                            <input type="hidden" name="trip_saved_id" value="<?= $row['trip_saved_id'] ?>">
                            <div class="mb-3">
