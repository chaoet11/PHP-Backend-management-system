                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="trip_saved_id" class="form-label">trip_saved_id</label>
                                <input type="text" class="form-control" id="trip_saved_id" name="trip_saved_id">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="./trip_saved_list.php">Return</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    const {
        trip_saved_id: trip_saved_id_f,
        trip_plan_id: trip_plan_id_f,
        user_id: user_id_f,
        movie_id: movie_id_f,
        bar_id: bar_id_f
    } = document.form1;
    ...
    function submitCsv() {
        ...
        fetch('trip_saved_add_CSV-api.php', {
                method: 'POST',
                body: formData,
            })
            .then(response => {
