                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="trip_detail_id" class="form-label">trip_detail_id</label>
                                <input type="text" class="form-control" id="trip_detail_id" name="trip_detail_id">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="block" name="block" required>
                                    <option value="" disabled selected>Please choose a time block.</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                </select>
                                <div class="invalid-feedback">Please choose a valid time block.</div>
                            </div>
                            <div class="mb-3">
                                <label for="movie_id" class="form-label">movie_id</label>
                                <input type="text" class="form-control" id="movie_id" name="movie_id">
                                <div class="invalid-feedback">Please provide a valid movie_id.</div>
                            </div>
                            <div class="mb-3">
