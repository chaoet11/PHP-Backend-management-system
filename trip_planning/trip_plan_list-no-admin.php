...
if ($totalRows > 0) {
    ...
    $sql = sprintf("SELECT * FROM trip_plans ORDER BY %s %s LIMIT %s, %s", $sortColumn, $order, ($page - 1) * $perPage, $perPage);
    $stmt = $pdo->query($sql);
    $rows = $stmt->fetchAll();
}
?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto me-3">
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-primary mb-3 me-2" onclick="searchData()">搜尋</button>
                        <!-- Return button  -->
                        <div class="col-auto">
                            <a href="trip_plan_list.php" class="btn btn-primary mb-3">返回</a>
                        </div>
                        <!-- Return button  -->
                    </div>
                </div>
...
<script>
    function delete_one(trip_plan_id) {
        if (confirm(`是否要刪除編號為 ${trip_plan_id} 的資料?`)) {
