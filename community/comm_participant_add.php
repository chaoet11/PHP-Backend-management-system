                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="comm_participant_id" class="form-label">comm_participant_id</label>
                                <input type="text" class="form-control" id="comm_participant_id" name="comm_participant_id" required>
                                <div class="invalid-feedback">Please provide a valid comm_participant_id.</div>
                            </div> -->
                            <div class="mb-3">
...
<script>
    const sendForm = e => {
        ...
        if (isPassed) {
            ...
            fetch('comm_participant_add-api.php', {
                method: 'POST',
