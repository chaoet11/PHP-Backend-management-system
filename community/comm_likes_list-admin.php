...
if ($totalRows > 0) {
    ...
    $sql = sprintf(
        "SELECT cl.*, mu.username FROM comm_likes AS cl
        JOIN member_user AS mu ON cl.user_id = mu.user_id
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-10">
            ...
            <div class="row align-items-center">
                ...
                <!-- add button start -->
                <div class="col-auto">
                    <a href="comm_likes_add.php" class="btn btn-primary mb-3"><i class="fa-solid fa-plus"></i></a>
                </div>
                <!-- add end start -->
            </div>
                ...
                <table class="table table-bordered table-striped table-primary">
                    ...
                    <tbody>
                        <?php foreach ($rows as $row) : ?>
                            <tr>
                                <td>
                                    <a href="javascript: delete_one(<?= $row['comm_likes_id'] ?>)">
                                ...
                                <!-- 避免 XSS 攻擊問題 -->
                                <td>
                                    <a href="comm_likes_edit.php?comm_likes_id=<?= $row['comm_likes_id'] ?>">
    ...
    function updateTable(data) {
        ...
        data.forEach(row => {
            ...
            tr.innerHTML = `
                ...
                <td>${row.comm_likes_id}</td>
                <td>${row.post_id}</td>
                <td>${row.username}</td> <!-- 正確顯示 Username -->
                <td>
                    <a href="comm_likes_edit.php?comm_likes_id=${row.comm_likes_id}">
                        <i class="fa-solid fa-file-pen"></i>
                    </a>
