...
$sql = "SELECT * FROM comm_saved WHERE comm_saved_id=$comm_saved_id";

$row = $pdo->query($sql)->fetch();
if (empty($row)) {
    header('Location: comm_saved_list.php');
    exit; # 結束 php 程式 
}
?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="sendForm(event)">
                        <div class="mb-3">
                            <label class="form-label">comm_saved_id</label>
                            <input type="text" class="form-control" disabled value="<?= $row['comm_saved_id'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <input type="hidden" name="comm_saved_id" value="<?= $row['comm_saved_id'] ?>">
                        <div class="mb-3">
