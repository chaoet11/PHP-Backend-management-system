                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="comm_photo_id" class="form-label">comm_photo_id</label>
                                <input type="text" class="form-control" id="comm_photo_id" name="comm_photo_id" required>
                                <div class="invalid-feedback">Please provide a valid comm_photo_id.</div>
                            </div> -->
                            <div class="mb-3">
                                <label for="photo_name" class="form-label">photo_name</label>
                                <input type="text" class="form-control" id="photo_name" name="photo_name" required>
                                <div class="invalid-feedback">Please provide a valid photo_name.</div>
                            </div>
                            <div class="mb-3">
                                <label for="post_id" class="form-label">post_id</label>
                                <input type="text" class="form-control" id="post_id" name="post_id" required>
                                <div class="invalid-feedback">Please provide a valid post_id.</div>
                            </div>
                            <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="./comm_photo_list.php">Return</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    const {
        comm_photo_id: comm_photo_id_f,
        photo_name: photo_name_f,
        post_id: post_id_f,
    } = document.form1;
