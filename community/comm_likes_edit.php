...
$sql = "SELECT * FROM comm_likes WHERE comm_likes_id=$comm_likes_id";

$row = $pdo->query($sql)->fetch();
if (empty($row)) {
    header('Location: comm_likes_list.php');
    exit; # 結束 php 程式 
}
?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="sendForm(event)">
                        <div class="mb-3">
                            <label class="form-label">comm_likes_id</label>
                            <input type="text" class="form-control" disabled value="<?= $row['comm_likes_id'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <input type="hidden" name="comm_likes_id" value="<?= $row['comm_likes_id'] ?>">
                        <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="./comm_likes_list.php">Return</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const sendForm = e => {
        ...
        // 檢查是否有更改
        let isChanged = initialValues.post_id !== document.form1.post_id.value ||
