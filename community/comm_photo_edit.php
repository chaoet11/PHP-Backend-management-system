...
$sql = "SELECT * FROM comm_photo WHERE comm_photo_id=$comm_photo_id";
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="sendForm(event)">
                        <div class="mb-3">
                            <label class="form-label">comm_photo_id</label>
                            <input type="text" class="form-control" disabled value="<?= $row['comm_photo_id'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <input type="hidden" name="comm_photo_id" value="<?= $row['comm_photo_id'] ?>">
                        <div class="mb-3">
...
<script>
    let initialValues = {
        photo_name: document.form1.photo_name.value,
    ...
    const sendForm = e => {
        ...
        // 檢查是否有更改
        let isChanged = initialValues.photo_name !== document.form1.photo_name.value ||
