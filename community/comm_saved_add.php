                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <div class="mb-3">
                                <!-- <label for="comm_saved_id" class="form-label">comm_saved_id</label>
                                <input type="text" class="form-control" id="comm_saved_id" name="comm_saved_id" required>
                                <div class="invalid-feedback">Please provide a valid comm_saved_id.</div>
                            </div> -->
                            <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="./comm_saved_list.php">Return</a>
            </div>
        </div>
    </div>
</div>
