                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form name="form1" method="post" class="needs-validation" novalidate onsubmit="sendForm(event)">
                            <!-- <div class="mb-3">
                                <label for="comm_likes_id" class="form-label">comm_likes_id</label>
                                <input type="text" class="form-control" id="comm_likes_id" name="comm_likes_id" required>
                                <div class="invalid-feedback">Please provide a valid comm_likes_id.</div>
                            </div> -->
                            <div class="mb-3">
