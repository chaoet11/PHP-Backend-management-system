...
$sql = "SELECT * FROM comm_participants WHERE comm_participant_id=$comm_participant_id";

$row = $pdo->query($sql)->fetch();
if (empty($row)) {
    header('Location: comm_participant_list.php');
    exit; # 結束 php 程式 
}
?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form name="form1" method="post" onsubmit="sendForm(event)">
                        <div class="mb-3">
                            <label class="form-label">comm_participant_id</label>
                            <input type="text" class="form-control" disabled value="<?= $row['comm_participant_id'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <input type="hidden" name="comm_participant_id" value="<?= $row['comm_participant_id'] ?>">
                        <!-- <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="comm_event_id" name="comm_event_id"
                                value="<?= $row['comm_event_id'] ?>">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="./comm_participant_list.php">Return</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const sendForm = e => {
        ...
        if (isPassed) {
            ...
            fetch('comm_participant_edit-api.php', {
                method: 'POST',
